...
class AsyncBaseTracer(AsyncCallbackHandler, ABC):
    """Base interface for async tracers."""
    ...
    async def on_chat_model_start(
        ...
        **kwargs: Any,
        ...
        await self._start_trace(chat_model_run)
        await self._on_chat_model_start(chat_model_run)
    ...
    async def on_llm_start(
        ...
        **kwargs: Any,
        ...
        await self._start_trace(llm_run)
        await self._on_llm_start(llm_run)
        return llm_run
    ...
    async def on_llm_end(self, response: LLMResult, *, run_id: UUID, **kwargs: Any) -> Run:
        ...
        await self._end_trace(llm_run)
        await self._on_llm_end(llm_run)
        return llm_run
    ...
    async def on_llm_error(
        ...
        **kwargs: Any,
        ...
        await self._end_trace(llm_run)
        await self._on_llm_error(llm_run)
        return llm_run
    ...
    async def on_chain_start(
        ...
        **kwargs: Any,
        ...
        await self._start_trace(chain_run)
        await self._on_chain_start(chain_run)
        return chain_run
    ...
    async def on_chain_end(
        ...
        **kwargs: Any,
        ...
        await self._end_trace(chain_run)
        await self._on_chain_end(chain_run)
        return chain_run
    ...
    async def on_chain_error(
        ...
        **kwargs: Any,
        ...
        if inputs is not None:
            chain_run.inputs = self._get_chain_inputs(inputs)
        await self._end_trace(chain_run)
        await self._on_chain_error(chain_run)
        return chain_run
    ...
    async def on_tool_start(
        ...
        **kwargs: Any,
        ...
        await self._start_trace(tool_run)
        await self._on_tool_start(tool_run)
        return tool_run

    async def on_tool_end(self, output: Any, *, run_id: UUID, **kwargs: Any) -> Run:
        ...
        await self._end_trace(tool_run)
        await self._on_tool_end(tool_run)
        return tool_run
    ...
    async def on_tool_error(
        ...
        **kwargs: Any,
        ...
        await self._end_trace(tool_run)
        await self._on_tool_error(tool_run)
        return tool_run
    ...
    async def on_retriever_start(
        ...
        **kwargs: Any,
        ...
        await self._start_trace(retrieval_run)
        await self._on_retriever_start(retrieval_run)
    ...
    async def on_retriever_error(
        ...
        **kwargs: Any,
        ...
        await self._end_trace(retrieval_run)
        await self._on_retriever_error(retrieval_run)
        return retrieval_run
    ...
    async def on_retriever_end(
        ...
        await self._end_trace(retrieval_run)
        await self._on_retriever_end(retrieval_run)
        return retrieval_run

    def __deepcopy__(self, memo: dict) -> AsyncBaseTracer:
        """Deepcopy the tracer."""
        return self

    def __copy__(self) -> AsyncBaseTracer:
        """Copy the tracer."""
        return self
